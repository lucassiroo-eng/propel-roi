...
function buildHtml(hs: any, analysis: any, roi: RoiResult, lang: string): string {
  ...
  const UI: Record<string, Record<string, string>> = {
    es: { title: L.title, per_year: "/año", source_transcript: "basado en conversaciones", source_assumption: "estimación sectorial", h_per_emp: "h/mes por empleado", h_per_hr: "h/mes por admin de RRHH", h_per_mgr: "h/mes por responsable", page_of: "Hoja {n} de {total}", confidential: L.confidential, context: "Contexto", modules_header: L.modules_header, modules_sub: L.modules_sub, savings_col: L.savings_col, roi_header: L.roi_header, total_savings: L.total_savings, investment: L.investment, roi_est: L.roi_est, payback: "Payback", net_return: L.net_return, months: L.months, methodology: L.methodology, methodology_body: "Las horas indicadas son estimaciones conservadoras del tiempo que Factorial libera mensualmente por tipo de trabajador. Todas las cifras son asunciones basadas en benchmarks de empresas de tamaño similar, salvo donde se indique \"basado en conversaciones\". Requieren validación conjunta con el cliente.", staff_assumed: "Personal asumido", employees: "empleados", hr_admin: "admin de RRHH", managers: "responsables", hourly_cost: "Coste horario", per_emp: "h empleado", per_hr: "h admin", per_mgr: "h responsable", fact_label: "Propel ROI · Factorial", fact_sub: "Generado a partir de conversaciones y benchmarks del sector", replaces: "Reemplaza", estimated: "estimado" },

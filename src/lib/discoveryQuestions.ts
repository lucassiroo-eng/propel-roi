...
export const MODULE_INFO: Record<string, ModuleInfo> = {
  ...
  it_inventory: {
    ...
    valueProps: [
      ...
      { en: "Auto-deprovision on exit — no forgotten accounts or unreturned assets", es: "Desaprovisiona automáticamente en la baja — sin cuentas olvidadas ni activos sin devolver", fr: "Désapprovisionnement automatique à la sortie — aucun compte oublié ni actif non rendu", it: "Deprovisioning automatico all'uscita — nessun account dimenticato né dispositivo non restituito", pt: "Desaprovisionamento automático na saída — sem contas esquecidas nem equipamento não devolvido", de: "Automatisches Deprovisioning beim Austritt — keine vergessenen Konten oder nicht zurückgegebenen Geräte" },
    ],
  },
  one: {
    ...
    valueProps: [
      ...
      { en: "Available 24/7 in the employee's own language", es: "Disponible 24/7 en el idioma del empleado", fr: "Disponible 24h/24 dans la langue de l'employé", it: "Disponibile 24/7 nella lingua del dipendente", pt: "Disponível 24/7 no idioma do colaborador", de: "Rund um die Uhr verfügbar in der Sprache des Mitarbeiters" },
    ],
  },
...
> = {
  core: {
    employee: [{ en: "How many hours per month do you spend on HR admin (updating personal data, requesting documents, checking policies)?", es: "¿Cuántas horas al mes dedicáis a gestiones de RRHH (actualizar datos, pedir documentos, consultar políticas)?", fr: "Combien d'heures par mois passez-vous sur l'admin RH (mise à jour de données, demandes de documents, consultation des politiques) ?", it: "Quante ore al mese dedicate alla gestione HR (aggiornamento dati, richiesta documenti, verifica policy)?", de: "Wie viele Stunden pro Monat verbringen Sie mit HR-Verwaltung (Daten aktualisieren, Dokumente anfragen, Richtlinien prüfen)?", pt: "Quantas horas por mês dedicam a gestões de RH (atualizar dados, pedir documentos, consultar políticas)?" }],
    hr: [{ en: "How many hours does your HR team spend per new hire (onboarding admin, profile setup, documentation, access setup)?", es: "¿Cuántas horas dedica el equipo de RRHH a cada nueva incorporación (alta, configuración del perfil, documentación, accesos)?", fr: "Combien d'heures votre équipe RH consacre-t-elle à chaque nouvelle recrue (onboarding admin, création du profil, documentation, accès) ?", it: "Quante ore dedica il team HR per ogni nuova assunzione (onboarding, profilo, documentazione, accessi)?", de: "Wie viele Stunden verbringt Ihr HR-Team pro Neueinstellung (Onboarding, Profilerstellung, Dokumentation, Zugänge)?", pt: "Quantas horas dedica a equipa de RH a cada nova contratação (integração, perfil, documentação, acessos)?" }],
    manager: [{ en: "How much time per month do you lose looking for team info (contracts, org chart, headcount)?", es: "¿Cuánto tiempo al mes perdéis buscando info de vuestro equipo (contratos, organigrama, plantilla)?", fr: "Combien de temps par mois perdez-vous à chercher les infos de votre équipe (contrats, organigramme, effectifs) ?", it: "Quanto tempo al mese perdete a cercare informazioni del team (contratti, organigramma, organico)?", de: "Wie viel Zeit pro Monat verlieren Sie bei der Suche nach Team-Infos (Verträge, Organigramm, Personalstand)?", pt: "Quanto tempo por mês perdem à procura de informação da equipa (contratos, organograma, headcount)?" }],
  },
  time_off: {
    employee: [{ en: "How many hours per month do you spend requesting time off and checking your balance?", es: "¿Cuántas horas al mes dedicáis a solicitar ausencias y consultar vuestro saldo?", fr: "Combien d'heures par mois passez-vous à poser des congés et consulter votre solde ?", it: "Quante ore al mese dedicate a richiedere giorni liberi e consultare il saldo?", de: "Wie viele Stunden pro Monat verbringen Sie damit, Abwesenheiten zu beantragen und Ihr Guthaben zu prüfen?", pt: "Quantas horas por mês dedicam a solicitar ausências e consultar o saldo?" }],
  ...
  time_tracking: {
    employee: [{ en: "How many hours per month do you spend logging your hours?", es: "¿Cuántas horas al mes dedicáis a registrar vuestras horas?", fr: "Combien d'heures par mois passez-vous à enregistrer vos heures ?", it: "Quante ore al mese dedicate alla registrazione delle vostre ore?", de: "Wie viele Stunden pro Monat verbringen Sie mit dem Erfassen Ihrer Stunden?", pt: "Quantas horas por mês dedicam ao registo das horas?" }],
  ...
  time_planning: {
    employee: [{ en: "How many hours per month do you spend checking your schedule or coordinating swaps?", es: "¿Cuántas horas al mes dedicáis a consultar vuestro turno o coordinar cambios?", fr: "Combien d'heures par mois passez-vous à consulter votre planning ou coordonner des échanges ?", it: "Quante ore al mese dedicate a consultare il turno o coordinare i cambi?", de: "Wie viele Stunden pro Monat verbringen Sie damit, Ihren Schichtplan zu prüfen oder Tausche zu koordinieren?", pt: "Quantas horas por mês dedicam a consultar o turno ou coordenar trocas?" }],
  ...
  expenses: {
    employee: [{ en: "How many hours per month do you spend submitting expense reports?", es: "¿Cuántas horas al mes dedicáis a presentar notas de gastos?", fr: "Combien d'heures par mois passez-vous à soumettre des notes de frais ?", it: "Quante ore al mese dedicate alla presentazione delle note spese?", de: "Wie viele Stunden pro Monat verbringen Sie mit dem Einreichen von Spesenabrechnungen?", pt: "Quantas horas por mês dedicam a submeter notas de despesas?" }],
  ...
  projects: {
    employee: [{ en: "How many hours per month do you spend logging time to projects?", es: "¿Cuántas horas al mes dedicáis a imputar tiempo a proyectos?", fr: "Combien d'heures par mois passez-vous à saisir du temps sur les projets ?", it: "Quante ore al mese dedicate all'imputazione del tempo sui progetti?", de: "Wie viele Stunden pro Monat verbringen Sie damit, Zeit auf Projekte zu buchen?", pt: "Quantas horas por mês dedicam a imputar tempo a projetos?" }],
  ...
  complaints: {
    hr: [
      { en: "How much time per month does your HR team spend handling complaints through informal channels (email, in-person)?", es: "¿Cuánto tiempo al mes dedica vuestro equipo de RRHH a gestionar quejas o denuncias por canales informales (email, en persona)?", fr: "Combien de temps par mois votre équipe RH consacre-t-elle à traiter les plaintes par des canaux informels (email, en personne) ?", it: "Quanto tempo al mese il team HR dedica alla gestione di reclami tramite canali informali (email, di persona)?", de: "Wie viel Zeit pro Monat verbringt Ihr HR-Team mit Beschwerden durch informelle Kanäle (E-Mail, persönlich)?", pt: "Quanto tempo por mês dedica a equipa de RH a gerir queixas por canais informais (email, presencialmente)?" },
    ],
    manager: [
      { en: "How much time per month do your managers spend dealing with team conflict or compliance concerns?", es: "¿Cuánto tiempo al mes dedican vuestros managers a gestionar conflictos de equipo o temas de cumplimiento?", fr: "Combien de temps par mois vos managers passent-ils à gérer des conflits d'équipe ou des problèmes de conformité ?", it: "Quanto tempo al mese i manager dedicano alla gestione di conflitti di team o problemi di conformità?", de: "Wie viel Zeit pro Monat verbringen Ihre Manager mit Teamkonflikten oder Compliance-Problemen?", pt: "Quanto tempo por mês dedicam os gestores a resolver conflitos de equipa ou questões de conformidade?" },
    ],
  },
  lms: {
    ...
    hr: [{ en: "How many hours per month does your HR team spend creating and managing training content and tracking completions?", es: "¿Cuántas horas al mes dedica vuestro equipo de RRHH a crear contenido formativo y hacer seguimiento de completados?", fr: "Combien d'heures par mois votre équipe RH consacre-t-elle à créer du contenu de formation et suivre les complétions ?", it: "Quanto tempo al mese il team HR dedica alla gestione di reclami tramite canali informali (email, di persona)?", de: "Wie viel Zeit pro Monat verbringt Ihr HR-Team mit Beschwerden durch informelle Kanäle (E-Mail, persönlich)?" , pt: "Quantas horas por mês dedica a equipa de RH a criar conteúdo formativo e acompanhar conclusões?"}],
  },
  benefits_standard: {

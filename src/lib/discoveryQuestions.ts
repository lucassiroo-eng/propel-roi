...
> = {
  core: {
    employee: [{ en: "How many minutes per month do you spend on HR admin (updating personal data, requesting documents, checking policies)?", es: "¿Cuántos minutos al mes dedicáis a gestiones de RRHH (actualizar datos, pedir documentos, consultar políticas)?", fr: "Combien de minutes par mois passez-vous sur l'admin RH (mise à jour de données, demandes de documents, consultation des politiques) ?", it: "Quanti minuti al mese dedicate alla gestione HR (aggiornamento dati, richiesta documenti, verifica policy)?", de: "Wie viele Minuten pro Monat verbringen Sie mit HR-Verwaltung (Daten aktualisieren, Dokumente anfragen, Richtlinien prüfen)?", pt: "Quantos minutos por mês dedicam a gestões de RH (atualizar dados, pedir documentos, consultar políticas)?" }],

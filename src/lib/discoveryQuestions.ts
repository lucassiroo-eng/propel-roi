...
export const MODULE_INFO: Record<string, ModuleInfo> = {
  ...
  performance: {
    ...
    valueProps: [
      { en: "Customizable review cycles and templates", es: "Ciclos de evaluación y plantillas personalizables", fr: "Cycles d'évaluation et modèles personnalisables", it: "Customizable review cycles and templates", de: "Customizable review cycles and templates" },
      { en: "Goal tracking with OKR alignment", es: "Seguimiento de objetivos con alineación OKR", fr: "Suivi des objectifs avec alignement OKR", it: "Goal tracking with OKR alignment", de: "Goal tracking with OKR alignment" },
    ],
  },
  expenses: {
    ...
    valueProps: [
      { en: "Snap a receipt and submit in seconds", es: "Foto del ticket y envío en segundos", fr: "Photographiez le reçu et soumettez en quelques secondes", it: "Snap a receipt and submit in seconds", de: "Snap a receipt and submit in seconds" },
      { en: "Automatic policy validation and approval flows", es: "Validación automática de política y flujos de aprobación", fr: "Validation automatique de la politique et workflows d'approbation", it: "Automatic policy validation and approval flows", de: "Automatic policy validation and approval flows" },
    ],
  },
  trainings: {
    ...
    valueProps: [
      { en: "Track mandatory training completion automatically", es: "Seguimiento automático de formación obligatoria", fr: "Suivi automatique des formations obligatoires", it: "Track mandatory training completion automatically", de: "Track mandatory training completion automatically" },
      { en: "Centralized training catalog with enrollment", es: "Catálogo de formación centralizado con inscripción", fr: "Catalogue de formation centralisé avec inscription", it: "Centralized training catalog with enrollment", de: "Centralized training catalog with enrollment" },
    ],
  },
  compensations: {
    ...
    valueProps: [
      { en: "Salary benchmarking against market data", es: "Benchmarking salarial con datos de mercado", fr: "Benchmarking salarial avec des données de marché", it: "Salary benchmarking against market data", de: "Salary benchmarking against market data" },
      { en: "Budget control with real-time impact simulation", es: "Control presupuestario con simulación de impacto en tiempo real", fr: "Contrôle budgétaire avec simulation d'impact en temps réel", it: "Budget control with real-time impact simulation", de: "Budget control with real-time impact simulation" },
    ],
  },
  engagement: {
    ...
    valueProps: [
      { en: "Automated pulse surveys with trend analysis", es: "Encuestas pulse automáticas con análisis de tendencias", fr: "Enquêtes pulse automatisées avec analyse des tendances", it: "Automated pulse surveys with trend analysis", de: "Automated pulse surveys with trend analysis" },
  ...
  projects: {
    ...
    valueProps: [
      { en: "Track time and costs per project with full precision", es: "Controla el tiempo y los costes por proyecto con total precisión", fr: "Suivez le temps et les coûts par projet avec une précision totale", it: "Track time and costs per project with full precision", de: "Track time and costs per project with full precision" },
      { en: "Analyze labor costs, fixed costs and expenses in real time", es: "Analiza costes laborales, costes fijos y gastos en tiempo real", fr: "Analysez les coûts de main-d'œuvre, les coûts fixes et les dépenses en temps réel", it: "Analyze labor costs, fixed costs and expenses in real time", de: "Analyze labor costs, fixed costs and expenses in real time" },
      { en: "Optimize team allocation and detect budget overruns early", es: "Optimiza la asignación del equipo y detecta desviaciones de presupuesto a tiempo", fr: "Optimisez l'allocation des équipes et détectez les dépassements budgétaires à temps", it: "Optimize team allocation and detect budget overruns early", de: "Optimize team allocation and detect budget overruns early" },
    ],
  },
  headcount_planning: {
  ...
  complaints: {
    ...
    color: "#EF4444",
    valueProps: [
      { en: "Avoid sanctions and protect your company's reputation", es: "Evita sanciones y mantén la reputación e imagen de tu empresa", fr: "Évitez les sanctions et protégez la réputation de votre entreprise", it: "Avoid sanctions and protect your company's reputation", de: "Avoid sanctions and protect your company's reputation" },
      { en: "Integrate an anonymous and secure channel that complies with GDPR", es: "Integra un canal de denuncias anónimo y seguro que cumple con la GDPR", fr: "Intégrez un canal de signalement anonyme et sécurisé conforme au RGPD", it: "Integrate an anonymous and secure channel that complies with GDPR", de: "Integrate an anonymous and secure channel that complies with GDPR" },
      { en: "Provide a good experience for your team and avoid workplace climate issues", es: "Proporciona una buena experiencia a tu equipo y evita problemas de clima laboral", fr: "Offrez une bonne expérience à votre équipe et évitez les problèmes de climat social", it: "Provide a good experience for your team and avoid workplace climate issues", de: "Provide a good experience for your team and avoid workplace climate issues" },
    ],
  },
  benefits_standard: {
    ...
    valueProps: [
      { en: "Offer a modern benefits package to attract and retain talent without increasing salary costs", es: "Ofrece un paquete de beneficios moderno y competitivo para atraer y retener talento sin aumentar costes salariales", fr: "Offrez un package d'avantages modernes pour attirer et retenir les talents sans augmenter les coûts salariaux", it: "Offer a modern benefits package to attract and retain talent without increasing salary costs", de: "Offer a modern benefits package to attract and retain talent without increasing salary costs" },
      { en: "Increase team satisfaction by letting employees spend on what they truly value", es: "Aumenta la satisfacción del equipo permitiendo a los empleados gastar en lo que realmente valoran", fr: "Augmentez la satisfaction de l'équipe en laissant les employés dépenser sur ce qui compte pour eux", it: "Increase team satisfaction by letting employees spend on what they truly value", de: "Increase team satisfaction by letting employees spend on what they truly value" },
      { en: "Ensure tax compliance and manage enrollments, cancellations and limits from one place", es: "Garantiza el cumplimiento fiscal y gestiona altas, bajas y límites de consumo sin fricciones desde un único lugar", fr: "Garantissez la conformité fiscale et gérez les inscriptions, résiliations et limites depuis un seul endroit", it: "Ensure tax compliance and manage enrollments, cancellations and limits from one place", de: "Ensure tax compliance and manage enrollments, cancellations and limits from one place" },
    ],
  },
  benefits: {
    ...
    valueProps: [
      ...
      { en: "100% digital, instant and fully integrated with payroll", es: "100% digital, inmediato y totalmente integrado con nómina", fr: "100% digital, instantané et entièrement intégré à la paie", it: "100% digital, instant and fully integrated with payroll", de: "100% digital, instant and fully integrated with payroll" },
  ...
  integration_netsuite: {
    ...
    valueProps: [
      ...
      { en: "Single source of truth across HR and finance", es: "Fuente única de verdad para RRHH y finanzas", fr: "Source unique de vérité pour les RH et la finance", it: "Single source of truth across HR and finance", de: "Single source of truth across HR and finance" },
    ],
  },
  integration_sage_200: {
    ...
    valueProps: [
      ...
      { en: "Payroll and headcount data always up to date in SAGE", es: "Datos de nómina y plantilla siempre actualizados en SAGE", fr: "Données de paie et effectifs toujours à jour dans SAGE", it: "Payroll and headcount data always up to date in SAGE", de: "Payroll and headcount data always up to date in SAGE" },
    ],
  },
  integration_milena: {
    ...
    valueProps: [
      ...
      { en: "Eliminate manual re-entry and reduce payroll errors", es: "Elimina la re-introducción manual y reduce errores de nómina", fr: "Éliminez la re-saisie manuelle et réduisez les erreurs de paie", it: "Eliminate manual re-entry and reduce payroll errors", de: "Eliminate manual re-entry and reduce payroll errors" },
    ],
  },
  integration_suprema_xiptic: {
    ...
    valueProps: [
      ...
      { en: "No manual data export or reconciliation needed", es: "Sin necesidad de exportación manual ni conciliación", fr: "Aucune exportation manuelle ni réconciliation nécessaire", it: "No manual data export or reconciliation needed", de: "No manual data export or reconciliation needed" },
    ],
  },
  silae: {
...
> = {
  ...
  time_off: {
    ...
    hr: [{ en: "How many hours per month does leave management take (balances, carryover, policy exceptions)?", es: "¿Cuántas horas al mes os lleva la gestión de ausencias (saldos, arrastres, excepciones)?", fr: "Combien d'heures par mois prend la gestion des congés (soldes, reports, exceptions) ?", it: "How many hours per month does leave management take (balances, carryover, policy exceptions)?", de: "How many hours per month does leave management take (balances, carryover, policy exceptions)?" }],
    manager: [{ en: "How much time per month do you spend reviewing and approving leave requests?", es: "¿Cuánto tiempo al mes dedicáis a revisar y aprobar solicitudes de ausencia?", fr: "Combien de temps par mois passez-vous à examiner et approuver les demandes de congés ?", it: "How much time per month do you spend reviewing and approving leave requests?", de: "How much time per month do you spend reviewing and approving leave requests?" }],
  },
  time_tracking: {
    employee: [{ en: "How many minutes per day do you spend logging your hours?", es: "¿Cuántos minutos al día dedicáis a registrar vuestras horas?", fr: "Combien de minutes par jour passez-vous à enregistrer vos heures ?", it: "How many minutes per day do you spend logging your hours?", de: "How many minutes per day do you spend logging your hours?" }],
    hr: [{ en: "How many hours per month does timesheet collection and payroll reconciliation take?", es: "¿Cuántas horas al mes os lleva recopilar fichajes y cuadrar con nóminas?", fr: "Combien d'heures par mois prennent la collecte des feuilles de temps et le rapprochement avec la paie ?", it: "How many hours per month does timesheet collection and payroll reconciliation take?", de: "How many hours per month does timesheet collection and payroll reconciliation take?" }],
    manager: [{ en: "How much time per month do you spend reviewing timesheets and chasing missing entries?", es: "¿Cuánto tiempo al mes dedicáis a revisar fichajes y perseguir los que faltan?", fr: "Combien de temps par mois passez-vous à vérifier les feuilles de temps et relancer les retardataires ?", it: "How much time per month do you spend reviewing timesheets and chasing missing entries?", de: "How much time per month do you spend reviewing timesheets and chasing missing entries?" }],
  },
  time_planning: {
    employee: [{ en: "How many minutes per week do you spend checking your schedule or coordinating swaps?", es: "¿Cuántos minutos a la semana dedicáis a consultar vuestro turno o coordinar cambios?", fr: "Combien de minutes par semaine passez-vous à consulter votre planning ou coordonner des échanges ?", it: "How many minutes per week do you spend checking your schedule or coordinating swaps?", de: "How many minutes per week do you spend checking your schedule or coordinating swaps?" }],
    hr: [{ en: "How many hours per month does shift planning and communication take?", es: "¿Cuántas horas al mes os lleva planificar y comunicar los turnos?", fr: "Combien d'heures par mois prennent la planification et la communication des plannings ?", it: "How many hours per month does shift planning and communication take?", de: "How many hours per month does shift planning and communication take?" }],
    manager: [{ en: "How much time per month do you spend building schedules and managing coverage?", es: "¿Cuánto tiempo al mes dedicáis a crear horarios y gestionar coberturas?", fr: "Combien de temps par mois passez-vous à construire les plannings et gérer les remplacements ?", it: "How much time per month do you spend building schedules and managing coverage?", de: "How much time per month do you spend building schedules and managing coverage?" }],
  },
  payroll: {
    hr: [{ en: "How many hours does each payroll run take from data prep to close?", es: "¿Cuántas horas os lleva cada ciclo de nómina desde la preparación hasta el cierre?", fr: "Combien d'heures prend chaque cycle de paie, de la préparation à la clôture ?", it: "How many hours does each payroll run take from data prep to close?", de: "How many hours does each payroll run take from data prep to close?" }],
    manager: [{ en: "How much time per month do you spend communicating variable pay or payroll changes?", es: "¿Cuánto tiempo al mes dedicáis a comunicar variables de nómina o cambios salariales?", fr: "Combien de temps par mois passez-vous à communiquer les variables de paie ou les changements ?", it: "How much time per month do you spend communicating variable pay or payroll changes?", de: "How much time per month do you spend communicating variable pay or payroll changes?" }],
  },
  recruitment: {
    hr: [{ en: "How many hours per month does managing job postings, screening, and pipeline take?", es: "¿Cuántas horas al mes os lleva gestionar ofertas, cribado y pipeline de candidatos?", fr: "Combien d'heures par mois prennent la gestion des offres, le tri et le suivi du pipeline ?", it: "How many hours per month does managing job postings, screening, and pipeline take?", de: "How many hours per month does managing job postings, screening, and pipeline take?" }],
    manager: [{ en: "How much time per month do you spend on hiring tasks (interviews, feedback, coordination)?", es: "¿Cuánto tiempo al mes dedicáis a tareas de selección (entrevistas, feedback, coordinación)?", fr: "Combien de temps par mois passez-vous sur le recrutement (entretiens, retours, coordination) ?", it: "How much time per month do you spend on hiring tasks (interviews, feedback, coordination)?", de: "How much time per month do you spend on hiring tasks (interviews, feedback, coordination)?" }],
  },
  performance: {
    employee: [{ en: "How many hours per review cycle do you spend preparing self-evaluations?", es: "¿Cuántas horas por ciclo de evaluación dedicáis a preparar vuestra autoevaluación?", fr: "Combien d'heures par cycle d'évaluation passez-vous à préparer votre auto-évaluation ?", it: "How many hours per review cycle do you spend preparing self-evaluations?", de: "How many hours per review cycle do you spend preparing self-evaluations?" }],
    hr: [{ en: "How many hours per cycle does managing the review process take (setup, reminders, reports)?", es: "¿Cuántas horas por ciclo os lleva gestionar el proceso de evaluación (configuración, recordatorios, informes)?", fr: "Combien d'heures par cycle prend la gestion du processus d'évaluation (configuration, relances, rapports) ?", it: "How many hours per cycle does managing the review process take (setup, reminders, reports)?", de: "How many hours per cycle does managing the review process take (setup, reminders, reports)?" }],
    manager: [{ en: "How much time per cycle do you spend writing evaluations and giving feedback?", es: "¿Cuánto tiempo por ciclo dedicáis a redactar evaluaciones y dar feedback?", fr: "Combien de temps par cycle passez-vous à rédiger les évaluations et donner du feedback ?", it: "How much time per cycle do you spend writing evaluations and giving feedback?", de: "How much time per cycle do you spend writing evaluations and giving feedback?" }],
  },
  expenses: {
    employee: [{ en: "How many minutes does it take to submit an expense report?", es: "¿Cuántos minutos tardáis en presentar una nota de gastos?", fr: "Combien de minutes faut-il pour soumettre une note de frais ?", it: "How many minutes does it take to submit an expense report?", de: "How many minutes does it take to submit an expense report?" }],
    hr: [{ en: "How many hours per month does expense validation and reconciliation take?", es: "¿Cuántas horas al mes os lleva validar y conciliar los gastos?", fr: "Combien d'heures par mois prennent la validation et le rapprochement des notes de frais ?", it: "How many hours per month does expense validation and reconciliation take?", de: "How many hours per month does expense validation and reconciliation take?" }],
    manager: [{ en: "How much time per month do you spend reviewing and approving expense reports?", es: "¿Cuánto tiempo al mes dedicáis a revisar y aprobar notas de gastos?", fr: "Combien de temps par mois passez-vous à examiner et approuver les notes de frais ?", it: "How much time per month do you spend reviewing and approving expense reports?", de: "How much time per month do you spend reviewing and approving expense reports?" }],
  },
  trainings: {
    employee: [{ en: "How many hours per month do you spend on training admin (finding courses, registering, tracking)?", es: "¿Cuántas horas al mes dedicáis a admin de formación (buscar cursos, inscribiros, seguimiento)?", fr: "Combien d'heures par mois passez-vous sur l'admin formation (recherche, inscription, suivi) ?", it: "How many hours per month do you spend on training admin (finding courses, registering, tracking)?", de: "How many hours per month do you spend on training admin (finding courses, registering, tracking)?" }],
    hr: [{ en: "How many hours per month does managing the training plan and compliance tracking take?", es: "¿Cuántas horas al mes os lleva gestionar el plan de formación y el seguimiento de cumplimiento?", fr: "Combien d'heures par mois prennent la gestion du plan de formation et le suivi de conformité ?", it: "How many hours per month does managing the training plan and compliance tracking take?", de: "How many hours per month does managing the training plan and compliance tracking take?" }],
    manager: [{ en: "How much time per month do you spend identifying and coordinating training for your team?", es: "¿Cuánto tiempo al mes dedicáis a identificar y coordinar formación para vuestro equipo?", fr: "Combien de temps par mois passez-vous à identifier et coordonner la formation de votre équipe ?", it: "How much time per month do you spend identifying and coordinating training for your team?", de: "How much time per month do you spend identifying and coordinating training for your team?" }],
  },
  compensations: {
    hr: [{ en: "How many hours does each salary review cycle take?", es: "¿Cuántas horas os lleva cada ciclo de revisión salarial?", fr: "Combien d'heures prend chaque cycle de revue salariale ?", it: "How many hours does each salary review cycle take?", de: "How many hours does each salary review cycle take?" }],
    manager: [{ en: "How much time per review cycle do you spend on compensation decisions for your team?", es: "¿Cuánto tiempo por ciclo dedicáis a decisiones de compensación de vuestro equipo?", fr: "Combien de temps par cycle passez-vous sur les décisions de rémunération de votre équipe ?", it: "How much time per review cycle do you spend on compensation decisions for your team?", de: "How much time per review cycle do you spend on compensation decisions for your team?" }],
  },
  engagement: {
    hr: [{ en: "How many hours per month does running surveys and analyzing results take?", es: "¿Cuántas horas al mes os lleva lanzar encuestas y analizar resultados?", fr: "Combien d'heures par mois prennent le lancement des enquêtes et l'analyse des résultats ?", it: "How many hours per month does running surveys and analyzing results take?", de: "How many hours per month does running surveys and analyzing results take?" }],
    manager: [{ en: "How much time per month do you spend gathering and acting on team feedback?", es: "¿Cuánto tiempo al mes dedicáis a recoger y actuar sobre el feedback de vuestro equipo?", fr: "Combien de temps par mois passez-vous à recueillir le feedback de votre équipe et à agir dessus ?", it: "How much time per month do you spend gathering and acting on team feedback?", de: "How much time per month do you spend gathering and acting on team feedback?" }],
  },
  documents: {
    employee: [{ en: "How many minutes does it take to get a document from HR (certificate, payslip, contract)?", es: "¿Cuántos minutos tardáis en conseguir un documento de RRHH (certificado, nómina, contrato)?", fr: "Combien de minutes faut-il pour obtenir un document RH (attestation, bulletin, contrat) ?", it: "How many minutes does it take to get a document from HR (certificate, payslip, contract)?", de: "How many minutes does it take to get a document from HR (certificate, payslip, contract)?" }],
    hr: [{ en: "How many hours per month does document generation, signing, and filing take?", es: "¿Cuántas horas al mes os lleva generar, firmar y archivar documentos?", fr: "Combien d'heures par mois prennent la génération, la signature et l'archivage des documents ?", it: "How many hours per month does document generation, signing, and filing take?", de: "How many hours per month does document generation, signing, and filing take?" }],
  },
  procurement: {
    hr: [{ en: "How many hours per month does processing purchase requests take?", es: "¿Cuántas horas al mes os lleva procesar solicitudes de compra?", fr: "Combien d'heures par mois prend le traitement des demandes d'achat ?", it: "How many hours per month does processing purchase requests take?", de: "How many hours per month does processing purchase requests take?" }],
    manager: [{ en: "How much time per month do you spend on purchase requests and tracking?", es: "¿Cuánto tiempo al mes dedicáis a solicitudes de compra y seguimiento?", fr: "Combien de temps par mois passez-vous sur les demandes d'achat et leur suivi ?", it: "How much time per month do you spend on purchase requests and tracking?", de: "How much time per month do you spend on purchase requests and tracking?" }],
  },
  projects: {
    employee: [{ en: "How many minutes per day do you spend logging time to projects?", es: "¿Cuántos minutos al día dedicáis a imputar tiempo a proyectos?", fr: "Combien de minutes par jour passez-vous à saisir du temps sur les projets ?", it: "How many minutes per day do you spend logging time to projects?", de: "How many minutes per day do you spend logging time to projects?" }],
    manager: [{ en: "How much time per month do you spend tracking project hours and team allocation?", es: "¿Cuánto tiempo al mes dedicáis a controlar horas de proyecto y asignación del equipo?", fr: "Combien de temps par mois passez-vous à suivre les heures projet et l'allocation de l'équipe ?", it: "How much time per month do you spend tracking project hours and team allocation?", de: "How much time per month do you spend tracking project hours and team allocation?" }],
  },
  headcount_planning: {
    hr: [{ en: "How many hours per month does headcount planning and position tracking take?", es: "¿Cuántas horas al mes os lleva la planificación de plantilla y seguimiento de posiciones?", fr: "Combien d'heures par mois prennent la planification des effectifs et le suivi des postes ?", it: "How many hours per month does headcount planning and position tracking take?", de: "How many hours per month does headcount planning and position tracking take?" }],
    manager: [{ en: "How much time per quarter do you spend forecasting hiring needs?", es: "¿Cuánto tiempo por trimestre dedicáis a prever necesidades de contratación?", fr: "Combien de temps par trimestre passez-vous à prévoir vos besoins en recrutement ?", it: "How much time per quarter do you spend forecasting hiring needs?", de: "How much time per quarter do you spend forecasting hiring needs?" }],
  },
  it_inventory: {
    hr: [{ en: "How many hours does your HR team spend provisioning equipment and access for each new hire (laptop setup, accounts, badges)?", es: "¿Cuántas horas dedica vuestro equipo de RRHH a gestionar el material y los accesos necesarios para cada nueva incorporación (portátil, cuentas, tarjetas)?", fr: "Combien d'heures votre équipe RH consacre-t-elle à provisionner le matériel et les accès pour chaque nouvelle recrue (PC, comptes, badges) ?", it: "How many hours does your HR team spend provisioning equipment and access for each new hire (laptop setup, accounts, badges)?", de: "How many hours does your HR team spend provisioning equipment and access for each new hire (laptop setup, accounts, badges)?" }],
  },
  integration_business_central: {
    hr: [{ en: "How many hours per month do you spend on manual data entry between HR and Business Central?", es: "¿Cuántas horas al mes dedicáis a introducir datos manualmente entre RRHH y Business Central?", fr: "Combien d'heures par mois passez-vous à saisir manuellement des données entre les RH et Business Central ?", it: "How many hours per month do you spend on manual data entry between HR and Business Central?", de: "How many hours per month do you spend on manual data entry between HR and Business Central?" }],
  },
  integration_netsuite: {
    hr: [{ en: "How many hours per month do you spend on manual data entry between HR and NetSuite?", es: "¿Cuántas horas al mes dedicáis a introducir datos manualmente entre RRHH y NetSuite?", fr: "Combien d'heures par mois passez-vous à saisir manuellement des données entre les RH et NetSuite ?", it: "How many hours per month do you spend on manual data entry between HR and NetSuite?", de: "How many hours per month do you spend on manual data entry between HR and NetSuite?" }],
  },
  integration_sage_200: {
    hr: [{ en: "How many hours per month do you spend on manual data entry between HR and Sage 200?", es: "¿Cuántas horas al mes dedicáis a introducir datos manualmente entre RRHH y Sage 200?", fr: "Combien d'heures par mois passez-vous à saisir manuellement des données entre les RH et Sage 200 ?", it: "How many hours per month do you spend on manual data entry between HR and Sage 200?", de: "How many hours per month do you spend on manual data entry between HR and Sage 200?" }],
  },
  integration_sap: {
    hr: [{ en: "How many hours per month do you spend on manual data entry between HR and SAP?", es: "¿Cuántas horas al mes dedicáis a introducir datos manualmente entre RRHH y SAP?", fr: "Combien d'heures par mois passez-vous à saisir manuellement des données entre les RH et SAP ?", it: "How many hours per month do you spend on manual data entry between HR and SAP?", de: "How many hours per month do you spend on manual data entry between HR and SAP?" }],
  },
  integration_datev: {
    hr: [{ en: "How many hours per month do you spend on manual data entry between HR and DATEV?", es: "¿Cuántas horas al mes dedicáis a introducir datos manualmente entre RRHH y DATEV?", fr: "Combien d'heures par mois passez-vous à saisir manuellement des données entre les RH et DATEV ?", it: "How many hours per month do you spend on manual data entry between HR and DATEV?", de: "How many hours per month do you spend on manual data entry between HR and DATEV?" }],
  },
  integration_a3: {
    hr: [{ en: "How many hours per month do you spend on manual data entry between HR and A3?", es: "¿Cuántas horas al mes dedicáis a introducir datos manualmente entre RRHH y A3?", fr: "Combien d'heures par mois passez-vous à saisir manuellement des données entre les RH et A3 ?", it: "How many hours per month do you spend on manual data entry between HR and A3?", de: "How many hours per month do you spend on manual data entry between HR and A3?" }],
  },
  integration_xero: {
    hr: [{ en: "How many hours per month do you spend on manual data entry between HR and Xero?", es: "¿Cuántas horas al mes dedicáis a introducir datos manualmente entre RRHH y Xero?", fr: "Combien d'heures par mois passez-vous à saisir manuellement des données entre les RH et Xero ?", it: "How many hours per month do you spend on manual data entry between HR and Xero?", de: "How many hours per month do you spend on manual data entry between HR and Xero?" }],
  },
  integration_quickbooks: {
    hr: [{ en: "How many hours per month do you spend on manual data entry between HR and QuickBooks?", es: "¿Cuántas horas al mes dedicáis a introducir datos manualmente entre RRHH y QuickBooks?", fr: "Combien d'heures par mois passez-vous à saisir manuellement des données entre les RH et QuickBooks ?", it: "How many hours per month do you spend on manual data entry between HR and QuickBooks?", de: "How many hours per month do you spend on manual data entry between HR and QuickBooks?" }],
  },
  integration_milena: {
    hr: [{ en: "How many hours per month do you spend on manual data entry between HR and Milena?", es: "¿Cuántas horas al mes dedicáis a introducir datos manualmente entre RRHH y Milena?", fr: "Combien d'heures par mois passez-vous à saisir manuellement des données entre les RH et Milena ?", it: "How many hours per month do you spend on manual data entry between HR and Milena?", de: "How many hours per month do you spend on manual data entry between HR and Milena?" }],
  },
  integration_suprema_xiptic: {
    hr: [{ en: "How many hours per month do you spend syncing data with your access control system?", es: "¿Cuántas horas al mes dedicáis a sincronizar datos con vuestro sistema de control de acceso?", fr: "Combien d'heures par mois passez-vous à synchroniser les données avec votre système de contrôle d'accès ?", it: "How many hours per month do you spend syncing data with your access control system?", de: "How many hours per month do you spend syncing data with your access control system?" }],
  },
  silae: {
    hr: [{ en: "How many hours per month do you spend on manual data entry between HR and Silae?", es: "¿Cuántas horas al mes dedicáis a introducir datos manualmente entre RRHH y Silae?", fr: "Combien d'heures par mois passez-vous à saisir manuellement des données entre les RH et Silae ?", it: "How many hours per month do you spend on manual data entry between HR and Silae?", de: "How many hours per month do you spend on manual data entry between HR and Silae?" }],
  },
  complaints: {
    hr: [
  ...
  lms: {
    employee: [{ en: "How much time per month do your employees spend searching for and accessing training content?", es: "¿Cuánto tiempo al mes dedican vuestros empleados a buscar y acceder a contenido formativo?", fr: "Combien de temps par mois vos employés passent-ils à chercher et accéder au contenu de formation ?", it: "How much time per month do your employees spend searching for and accessing training content?", de: "How much time per month do your employees spend searching for and accessing training content?" }],
    hr: [{ en: "How many hours per month does your HR team spend creating and managing training content and tracking completions?", es: "¿Cuántas horas al mes dedica vuestro equipo de RRHH a crear contenido formativo y hacer seguimiento de completados?", fr: "Combien d'heures par mois votre équipe RH consacre-t-elle à créer du contenu de formation et suivre les complétions ?", it: "How many hours per month does your HR team spend creating and managing training content and tracking completions?", de: "How many hours per month does your HR team spend creating and managing training content and tracking completions?" }],
  },
  benefits_standard: {
    hr: [{ en: "How many hours per month does your HR team spend administrating employee benefits (enrollment, changes, queries)?", es: "¿Cuántas horas al mes dedica vuestro equipo de RRHH a administrar los beneficios de empleados (altas, cambios, consultas)?", fr: "Combien d'heures par mois votre équipe RH consacre-t-elle à administrer les avantages sociaux (inscriptions, modifications, demandes) ?", it: "How many hours per month does your HR team spend administrating employee benefits (enrollment, changes, queries)?", de: "How many hours per month does your HR team spend administrating employee benefits (enrollment, changes, queries)?" }],
    employee: [{ en: "How much time per month do your employees spend understanding and managing their benefits?", es: "¿Cuánto tiempo al mes dedican vuestros empleados a entender y gestionar sus beneficios?", fr: "Combien de temps par mois vos employés passent-ils à comprendre et gérer leurs avantages ?", it: "How much time per month do your employees spend understanding and managing their benefits?", de: "How much time per month do your employees spend understanding and managing their benefits?" }],
  },
  benefits: {
    hr: [{ en: "How many hours per month does your HR team spend managing salary advance requests and reconciliation?", es: "¿Cuántas horas al mes dedica vuestro equipo de RRHH a gestionar solicitudes de anticipo y su conciliación?", fr: "Combien d'heures par mois votre équipe RH consacre-t-elle à gérer les demandes d'avance sur salaire et leur réconciliation ?", it: "How many hours per month does your HR team spend managing salary advance requests and reconciliation?", de: "How many hours per month does your HR team spend managing salary advance requests and reconciliation?" }],
    employee: [{ en: "Have your employees ever faced financial stress between paydays that impacted their focus at work?", es: "¿Alguna vez vuestros empleados han tenido estrés financiero entre nóminas que ha afectado a su concentración en el trabajo?", fr: "Vos employés ont-ils déjà subi un stress financier entre deux salaires qui a affecté leur concentration au travail ?", it: "Have your employees ever faced financial stress between paydays that impacted their focus at work?", de: "Have your employees ever faced financial stress between paydays that impacted their focus at work?" }],
  },
};

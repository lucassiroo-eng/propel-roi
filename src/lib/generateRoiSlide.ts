...
<style>
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  .kpi-label { color: #fff; font-size: 17px; font-weight: 700; margin: 4px 0 8px 0; letter-spacing: 0.02em; white-space: nowrap; }
  ...
  .kpi-value { color: #FF355E; font-size: 28px; font-weight: 800; white-space: nowrap; font-variant-numeric: tabular-nums; }
  .kpi-sub { color: #FF355E; font-size: 14px; font-weight: 600; white-space: nowrap; opacity: 0.85; }

...
<style>
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  .kpi-label { color: #fff; font-size: 22px; font-weight: 700; margin: 4px 0 10px 0; letter-spacing: 0.02em; white-space: nowrap; }
  ...
  .kpi-value { color: #FF355E; font-size: 40px; font-weight: 800; white-space: nowrap; font-variant-numeric: tabular-nums; }
  .kpi-sub { color: #FF355E; font-size: 18px; font-weight: 600; white-space: nowrap; opacity: 0.85; }
...
<style>
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  .module-table .total-row td { padding-top: ${rowPad + 4}px !important; border-top: 2px solid #E5E7EB; border-bottom: none; }
